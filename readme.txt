...
== Screenshots ==
No screenshots, just good ol' fashioned code.
...
=To-Do=
* Settings page
* [Exclude mime-types option](http://wordpress.org/support/topic/plugin-ap-extended-mime-types-idea-exclude-file-types "WordPress.org Forum Post")
